...
<img src="<?php bloginfo('template_directory'); ?>/images/content-bottom<?php global $fullwidth; if (is_page_template('page-full.php') || ($fullwidth)) echo"-full"; ?>.gif" alt="top" style="float: left;" />
</div>
<div style="clear: both;"></div>
</div>
</div>
