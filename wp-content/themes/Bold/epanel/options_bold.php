...
function custom_colors_css(){
	...
	<style type="text/css">
		body { color: #<?php echo(get_option($shortname.'_color_mainfont')); ?> !important; }
		a:link, a:visited { color: #<?php echo(get_option($shortname.'_color_mainlink')); ?> !important; }
		#pages-inside li a, .current_page_item a, .home-link a { color: #<?php echo(get_option($shortname.'_color_pagelink')); ?> !important; }
		#pages-inside li a:hover { color: #<?php echo(get_option($shortname.'_color_pagelink_hover')); ?>!important; }
		.pics div h1 a { color: #<?php echo(get_option($shortname.'_color_featheader')); ?> !important; }
		.post-title a, .post-title-2 a, .titles-featured a { color:#<?php echo(get_option($shortname.'_color_recentheadings')); ?> !important; }
		.sidebar-box-title { color:#<?php echo(get_option($shortname.'_color_sidebar_titles')); ?> !important; }
		.footer-box h3 { color:#<?php echo(get_option($shortname.'_color_footer_titles')); ?> !important; }
		#sidebar a { color:#<?php echo(get_option($shortname.'_color_sidebar_links')); ?> !important; }
		.footer-box li a:link, .footer-box li a:hover, .footer-box li a:visited, .footer-box li a  { color:#<?php echo(get_option($shortname.'_color_footer_link')); ?> !important; }
		.slogan { color:#<?php echo(get_option($shortname.'_color_slogan')); ?> !important; }
	</style>
