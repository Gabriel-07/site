...
$ids = array();
$loopcounter = 0;
query_posts("showposts=".get_option('bold_homepage_featured')."&cat=".get_catId(get_option('bold_feat_cat')));
...
<span class="titles-featured"><a href="<?php the_permalink() ?>" rel="bookmark" title="<?php the_permalink() ?>" title="<?php printf(esc_attr__('Permanent Link to %s','Bold'), get_the_title()) ?>">
    ...
    <a href="<?php the_permalink() ?>" rel="bookmark" class="featured-readmore" title="<?php the_permalink() ?>" title="<?php printf(esc_attr__('Permanent Link to %s','Bold'), get_the_title()) ?>">
