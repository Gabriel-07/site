...
class mh_nip_widget extends WP_Widget {
    ...
    function form($instance) {
        ...
        <p>
			...
			<input type="text" size="2" value="<?php echo esc_attr($instance['postcount']); ?>" name="<?php echo $this->get_field_name('postcount'); ?>" id="<?php echo $this->get_field_id('postcount'); ?>" /> <?php _e('Pictures', 'mh'); ?>
	    </p>   
	    <p>
