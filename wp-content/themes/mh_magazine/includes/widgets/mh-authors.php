...
class mh_authors_widget extends WP_Widget {
    ...
    function form($instance) {
        ...
        <p>
        <label for="<?php echo $this->get_field_id('authorcount'); ?>"><?php _e('Show:', 'mh'); ?></label>
        <input type="text" size="2" value="<?php echo esc_attr($instance['authorcount']); ?>" name="<?php echo $this->get_field_name('authorcount'); ?>" id="<?php echo $this->get_field_id('authorcount'); ?>" /> <?php _e('Authors', 'mh'); ?>
	    </p>
	    <p>
        <label for="<?php echo $this->get_field_id('offset'); ?>"><?php _e('Skip:', 'mh'); ?></label>
        <input type="text" size="2" value="<?php echo esc_attr($instance['offset']); ?>" name="<?php echo $this->get_field_name('offset'); ?>" id="<?php echo $this->get_field_id('offset'); ?>" /> <?php _e('Authors', 'mh'); ?>
	    </p> 
	    <p>
	    <label for="<?php echo $this->get_field_id('role'); ?>"><?php _e('Role:', 'mh'); ?></label>
        ...
        <p>
	    <label for="<?php echo $this->get_field_id('orderby'); ?>"><?php _e('Order by:', 'mh'); ?></label>
