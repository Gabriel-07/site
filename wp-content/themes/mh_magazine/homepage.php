...
<div class="wrapper hp clearfix">
	...
	<?php if (isset($options['site_width']) && $options['site_width'] == 'large' && is_active_sidebar('home-12') || isset($options['2nd_sidebar']) && $options['2nd_sidebar'] && is_active_sidebar('home-12')) { ?>
